...
class PerformanceProfiler:
    ...
    def profile_plotting_pipeline(self, n_samples=5000, n_channels=4):
        ...
        print(f"Profiling plotting pipeline: {n_samples} samples, {n_channels} channels")
        print("=" * 60)
    ...
    def memory_usage_analysis(self, n_samples=20000):
        ...
        try:
            ...
            print(f"After data generation: {data_gen_mb:.1f} MB (+{data_gen_mb-baseline_mb:.1f} MB)")
            ...
            with temp_output_dir() as output_dir:
                ...
                print(f"Peak during plotting: {peak_mb:.1f} MB (+{peak_mb-baseline_mb:.1f} MB)")
                print(f"Memory efficiency: {data_size_mb/(peak_mb-baseline_mb):.2f} (data_size/memory_used)")
    ...
    def compare_data_types(self):
        ...
        data_types = [
            ...
            ("Complex waveform", lambda: generate_complex_waveform(n_samples, n_channels)),
            ("Noisy sine", lambda: generate_sine_waves(n_samples, n_channels, noise_level=0.3))
        ]
...
def run_full_profile():
    ...
    try:
        ...
        print(f"Alignment throughput: {alignment_results['throughput']:.0f} samples/sec")
