...
def benchmark_data_sizes():
    ...
    for n_samples in sizes:
        ...
        with temp_output_dir() as output_dir:
            ...
            print(f"  {n_samples} samples: {elapsed:.3f}s ({samples_per_sec:.0f} samples/sec)")
...
def benchmark_channel_scaling():
    ...
    for n_channels in channel_counts:
        ...
        with temp_output_dir() as output_dir:
            ...
            print(f"  {n_channels} channels: {elapsed:.3f}s ({channels_per_sec:.1f} channels/sec)")
...
def benchmark_resolution_impact():
    ...
    for width, height in resolutions:
        ...
        with temp_output_dir() as output_dir:
            ...
            print(f"  {width}x{height}: {elapsed:.3f}s ({pixels_per_sec/1000:.0f}k pixels/sec)")
...
def run_comprehensive_benchmark():
    ...
    try:
        ...
        print(f"Peak throughput: {max(size_results.keys())/min(size_results.values()):.0f} samples/sec")
        print(f"Best channel efficiency: {max(channel_results.keys())/min(channel_results.values()):.1f} channels/sec")
