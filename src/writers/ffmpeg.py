...
class FFmpegWriter:
    ...
    def _build_ffmpeg_cmd(self, w: int, h: int, fps: float, 
                         alpha: bool, input_pix: str, use_cpu: bool) -> List[str]:
...
def create_ffmpeg_writer(out_path: Path, w: int, h: int, fps: float, 
                        alpha: bool, use_cpu: bool = True, 
                        use_rgb24: bool = False) -> FFmpegWriter:
